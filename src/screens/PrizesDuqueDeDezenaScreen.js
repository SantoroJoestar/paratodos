...
const PrizesDuqueDeDezenaScreen = ({ navigation, route }) => {
  ...
  const handleProceed = () => {
    if (betValues.length === 0) {
      ...
      navigation.navigate('FinalizeDuqueDeDezenaScreen', { numbers: route.params.numbers, betValues });
    }
  };
...
export default PrizesDuqueDeDezenaScreen;
