...
const PrizesMilharCentenaScreen = ({ navigation, route }) => {
  ...
  const handleProceed = () => {
    if (betValues.length === 0) {
      ...
      navigation.navigate('FinalizeGameMilharCentenaScreen', { numbers: route.params.numbers, betValues });
    }
  };
...
export default PrizesMilharCentenaScreen;
