...
const PrizesMilharDezenaScreen = ({ navigation, route }) => {
  ...
  const handleProceed = () => {
    if (betValues.length === 0) {
      ...
      navigation.navigate('FinalizeGameMilharDezenaScreen', { numbers: route.params.numbers, betValues });
    }
  };
...
export default PrizesMilharDezenaScreen;
