...
const PrizesCentenaInvertidaScreen = ({ navigation, route }) => {
  ...
  const handleProceed = () => {
    if (betValues.length === 0) {
      ...
      navigation.navigate('FinalizeCentenaInvertidaScreen', { numbers: route.params.numbers, betValues });
    }
  };
          ...
          <View style={localStyles.centeredView}>
            <View style={localStyles.modalView}>
              ...
              {[1, 2, 3, 4, 5].map((prizeNumber) => (
                ...
                >
                  <Text style={localStyles.prizeButtonText}>{`${prizeNumber}º Prêmio`}</Text>                </TouchableOpacity>
              ))}
              <TextInput
...
export default PrizesCentenaInvertidaScreen;
