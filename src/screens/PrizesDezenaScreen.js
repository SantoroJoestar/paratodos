...
const PrizesDezenaScreen = ({ navigation, route }) => {
  ...
  const handleProceed = () => {
    if (betValues.length === 0) {
      ...
      navigation.navigate('FinalizeDezenaScreen', { numbers: route.params.numbers, betValues });
    }
  };
...
export default PrizesDezenaScreen;
