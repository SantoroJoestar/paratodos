...
const PrizesMilharCentenaDezenaScreen = ({ navigation, route }) => {
  ...
  const handleProceed = () => {
    if (betValues.length === 0) {
      ...
      navigation.navigate('FinalizeGameMilharCentenaDezenaScreen', { numbers: route.params.numbers, betValues });
    }
  };
...
export default PrizesMilharCentenaDezenaScreen;
