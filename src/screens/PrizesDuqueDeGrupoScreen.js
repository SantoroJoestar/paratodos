...
const PrizesDuqueDeGrupoScreen = ({ navigation, route }) => {
  ...
  const handleProceed = () => {
    if (betValues.length === 0) {
      ...
      navigation.navigate('FinalizeDuqueDeGrupoScreen', { numbers: route.params.numbers, betValues });
    }
  };
...
export default PrizesDuqueDeGrupoScreen;
