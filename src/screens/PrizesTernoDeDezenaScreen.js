...
const PrizesTernoDeDezenaScreen = ({ navigation, route }) => {
  ...
  const handleProceed = () => {
    if (betValues.length === 0) {
      ...
      navigation.navigate('FinalizeTernoDeDezenaScreen', { numbers: route.params.numbers, betValues });
    }
  };
...
export default PrizesTernoDeDezenaScreen;
