...
const PrizesCentenaDezenaScreen = ({ navigation, route }) => {
  ...
  const handleProceed = () => {
    if (betValues.length === 0) {
      ...
      navigation.navigate('FinalizeCentenaDezenaScreen', { numbers: [route.params.numbers], betValues });
    }
  };
...
export default PrizesCentenaDezenaScreen;
