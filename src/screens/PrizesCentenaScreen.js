...
const PrizesCentenaScreen = ({ navigation, route }) => {
  ...
  const handleProceed = () => {
    if (betValues.length === 0) {
      ...
      navigation.navigate('FinalizeCentenaScreen', { numbers: [route.params.number], betValues });
    }
  };
...
export default PrizesCentenaScreen;
