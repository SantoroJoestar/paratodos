...
const PrizesGrupoScreen = ({ navigation, route }) => {
  ...
  const handleProceed = () => {
    if (betValues.length === 0) {
      ...
      navigation.navigate('FinalizeGrupoScreen', { numbers: route.params.numbers, betValues });
    }
  };
...
export default PrizesGrupoScreen;
