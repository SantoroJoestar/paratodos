...
const FinalizeGameMilharInvertidaScreen = ({ route }) => {
    ...
    return (
        <ScrollView contentContainerStyle={styles.scrollContainer}>
            <View style={styles.container}>
                <Text style={styles.title}>Finalizar Jogo Milhar Invertida</Text>
...
export default FinalizeGameMilharInvertidaScreen;
