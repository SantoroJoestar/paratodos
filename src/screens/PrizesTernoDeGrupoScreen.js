...
const PrizesTernoDeGrupoScreen = ({ navigation, route }) => {
  ...
  const handleProceed = () => {
    if (betValues.length === 0) {
      ...
      navigation.navigate('FinalizeTernoDeGrupoScreen', { numbers: route.params.numbers, betValues });
    }
  };
...
export default PrizesTernoDeGrupoScreen;
